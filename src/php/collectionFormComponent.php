...
$selectedVolunteersList = isset($selectedVolunteersList) ? $selectedVolunteersList : [];
if (!isset($collectedWastesList) || empty($collectedWastesList)) {
    $collectedWastesList = [['type_dechet' => '', 'quantite_kg' => '']];
}

function buildWasteSelectOptions($wasteTypesList, $selected = '')
{
...
$defaultWasteOptions = buildWasteSelectOptions($wasteTypesList);
?>
